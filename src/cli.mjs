...
Commands:
  Studio 管理:
    ...
    activate <place_path>           激活（前置）Studio 窗口
    hide <place_path>               隐藏 Studio 窗口
  ...
  try {
    ...
    switch (command) {
      ...
      case "activate": {
        ...
        result = await activate(placePath);
        break;
      }
